...
const moments = [
  ['Morning','Welcome & free play','A personal hello, a quick family check-in and time to settle in with familiar toys and friends.'],
  ['Morning','A nourishing breakfast','A balanced breakfast around the table, with simple Spanish words woven into conversation.'],
  ['Mid-morning','Learn through play','Songs, stories, sensory activities, art and hands-on discovery in both English and Spanish.'],
  ['Late morning','Fresh air & movement','A walk, a park visit or outdoor play whenever weather and conditions allow.'],
  ['Midday','Lunch & peaceful rest','A fresh, age-appropriate meal followed by a calm transition to naps or quiet activities.'],
  ['Afternoon','Snack, connection & pick-up','A nutritious snack, social play and a personal update for each family at the end of the day.']
];
let dayIndex = 0;
...
document.querySelector('.day-prev').addEventListener('click', () => showMoment(dayIndex - 1));
document.querySelector('.day-next').addEventListener('click', () => showMoment(dayIndex + 1));
